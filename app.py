...
if (selected == 'Diabetes Prediction'):
    ...
    with col1:
        Pregnancies = st.text_input('Number of Pregnancies',key="Number of Pregnancies")
        
        
    with col2:
        Glucose = st.text_input('Glucose Level',key="Glucose Level")
    
    with col3:
        BloodPressure = st.text_input('Blood Pressure value',key="Blood Pressure value")
    
    with col1:
        SkinThickness = st.text_input('Skin Thickness value',key="Skin Thickness value")
    
    with col2:
        Insulin = st.text_input('Insulin Level',key="Insulin Level")
    
    with col3:
        BMI = st.text_input('BMI value',key="BMI value")
    
    with col1:
        DiabetesPedigreeFunction = st.text_input('Diabetes Pedigree Function value',key="Diabetes Pedigree Function value")
    
    with col2:
        Age = st.text_input('Age of the Person',key="Age of the Person")
